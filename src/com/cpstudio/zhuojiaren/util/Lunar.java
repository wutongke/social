...
public class Lunar {
	...
	static final String chineseYueNumber[] = { "正", "二", "三", "四", "五", "六", "七",
			"八", "九", "十", "冬", "腊" };
	
	static final String chineseNumber[] = { "一", "二", "三", "四", "五", "六", "七",
		"八", "九", "十", "十一", "十二" };
	...
	public String toString() {
		return year + "年" + (leap ? "闰" : "") + chineseYueNumber[month - 1] + "月"
				+ getChinaDayString(day);
	}
	
	public String getLunarStr() {
		return cyclical() + "年   " + (leap ? "闰" : "") + chineseYueNumber[month - 1] + "月   "
				+ getChinaDayString(day);
	}
