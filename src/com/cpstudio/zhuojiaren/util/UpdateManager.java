...
import com.cpstudio.zhuojiaren.model.Update;
...
//				try {					
//					Update update = ApiClient.checkVersion((AppContext)mContext.getApplicationContext(),curVersionCode);
//					msg.what = 1;
//					msg.obj = update;
...
//				handler.sendMessage(msg);
	...
	private Runnable mdownApkRunnable = new Runnable() {	
		...
		public void run() {
			try {
				String apkName = "LoveApp_"+mUpdate.getVersionName()+".apk";
				String tmpApk = "LoveApp_"+mUpdate.getVersionName()+".tmp";
				//判断是否挂载了SD卡
