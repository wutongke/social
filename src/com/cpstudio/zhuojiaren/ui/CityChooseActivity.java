...
import com.cpstudio.zhuojiaren.util.DBHelper;
import com.cpstudio.zhuojiaren.util.DatabaseHelper;
import com.cpstudio.zhuojiaren.util.PingYinUtil;
import com.cpstudio.zhuojiaren.widget.LetterListView;
import com.cpstudio.zhuojiaren.widget.LetterListView.OnTouchingLetterChangedListener;
		...
		personList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (position >= 4) {
					...
					data.putExtra("city", allCity_lists.get(position).getName());
		...
		resultList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Toast.makeText(getApplicationContext(),
						...
						.show();
				Intent data = new Intent();
				data.putExtra("city",city_result.get(position).getName());
				setResult(RESULT_OK, data);
				CityChooseActivity.this.finish();
			}
		});
				...
				rencentCity.setOnItemClickListener(new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> parent, View view,
						...
						Toast.makeText(getApplicationContext(),
								...
								.show();
						Intent data = new Intent();
						data.putExtra("city",city_history.get(position));
						setResult(RESULT_OK, data);
						CityChooseActivity.this.finish();
				...
				hotCity.setOnItemClickListener(new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> parent, View view,
						...
						Toast.makeText(getApplicationContext(),
								...
								Toast.LENGTH_SHORT).show();
						Intent data = new Intent();
						data.putExtra("city",city_hot.get(position).getName());
						setResult(RESULT_OK, data);
						CityChooseActivity.this.finish();
