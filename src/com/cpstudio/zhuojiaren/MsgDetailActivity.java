...
public class MsgDetailActivity extends Activity implements OnItemClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		pwh = new PopupWindows(MsgDetailActivity.this);
		mAdapter = new MsgCmtListAdapter(this, mList, msgid);
		mListView = (ListView) findViewById(R.id.listViewDetail);
		mListView.setDividerHeight(0);
		LayoutInflater inflater = LayoutInflater.from(MsgDetailActivity.this);
		mHeadView = (LinearLayout) inflater.inflate(R.layout.listview_header4,
				null);
	...
	public void loadHead(ZhuoInfoVO zhuoinfo) {
		...
		TextView workTV = (TextView) findViewById(R.id.textViewCmtContent);
		...
		if (type != null && !type.equals("")) {
			...
			TextView resTV = (TextView) findViewById(R.id.textViewRes);
		...
		if (pics != null && pics.size() > 0) {
			...
			for (int i = 0; i < pics.size(); i++) {
				if (i % 3 == 0) {
					tr = new TableRow(MsgDetailActivity.this);
					tl.addView(tr);
				}
				tr.setLayoutParams(tllp);
				RelativeLayout rl = new RelativeLayout(MsgDetailActivity.this);
				rl.setLayoutParams(trlp);
				ImageView iv = new ImageView(MsgDetailActivity.this);
		...
		if (users != null && !users.isEmpty()) {
			...
			int width = (int) (40 * DeviceInfoUtil
					.getDeviceCsd(MsgDetailActivity.this));
			RelativeLayout.LayoutParams rlp = new RelativeLayout.LayoutParams(
					width, width);
			TableRow tr = null;
	...
	private void loadData() {
		if (CommonUtil.getNetworkState(getApplicationContext()) == 2) {
			...
			mConnHelper.getFromServer(params, mUIHandler, MsgTagVO.DATA_LOAD,
					MsgDetailActivity.this, true, new OnCancelListener() {
	...
	private void initClick() {
		...
		findViewById(R.id.buttonChat).setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(MsgDetailActivity.this,
						ChatActivity.class);
		...
		findViewById(R.id.buttonTabZf).setOnClickListener(
				new OnClickListener() {
