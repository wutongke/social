...
public class LinkListAdapter extends BaseAdapter implements SectionIndexer {
	...
	public LinkListAdapter(Context context, ArrayList<UserVO> list) {
		this.mList = list;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = inflater.inflate(R.layout.item_link_list, null);
		...
		holder.textViewLetter.setText(start);
	...
	private ViewHolder initHolder(View convertView) {
		...
		holder.textViewLetter = (TextView) convertView
				.findViewById(R.id.textViewLetter);
		holder.textViewBorder = (TextView) convertView
				.findViewById(R.id.textViewBorder);
